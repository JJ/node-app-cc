...
class FSDator extends Dator {
		...
		if ( files[f] != 'resultado' ) {
		    ...
		    for (var q in quienes ) {
		      ...
		      esta_porra.apuestas[quienes[q]] = apuesta ;
                      ...
                      if ( ! files[f] in esta_porra.apostadores ) {
                         esta_porra.apostadores[files[f]] = [];
                      }
                      esta_porra.apostadores[files[f]].push( quienes[q] );
		    }
		} else {
  ...
  ganadores( porra_ID ) {
    ...
    console.log( this_porra );
    return this_porra.apuestas[ this_porra.resultado ];
  }
}
